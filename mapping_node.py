...
class Node:
    ...
    def create_child(self, direction, distance):
        if direction == Direction.LEFT:
            ...
            self.right_child = Node(self.x + distance, self.y)
            ...
            self.down_child = Node(self.x, self.y + distance)
            ...
            self.up_child = Node(self.x, self.y - distance)
